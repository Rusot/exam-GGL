...
# se configuran todas las acciones de los botones
...
def index():
    ...
    if request.method == 'POST':
        if 'save' in request.form:
            ...
            # al presionar el boton guardar, el dato se almacena en la base de datos

            new_data = request.form.get('inse')
            category = request.form.get('category')

            #se toma el dato de la entrada de texto out, y lo almacena en la base de datos
